...
public class KoalaPalacePage {
    ...
    @FindBy (id = "IDHotel")
    public WebElement odaIDDropDown;

    @FindBy (id = "Code")
    public WebElement odaCode;

    @FindBy ( xpath = "//input[@ placeholder ='Name']")
    public WebElement odaName;

    @FindBy ( id = "Location")
    public WebElement odaLocation;
    ...
    // Eğer bu webelementi görüyorsak herhangi bir kutuda hata vardır ve kayıt işlemi gerçekleşmemiştir
...
//==============================================================================
    ...
    @FindBy ( id = "Code")
    public WebElement hotelEditCode;

    @FindBy ( id = "Name")
    public WebElement hotelEditName;

    @FindBy ( id = "Address")
    public WebElement hotelEditAddress;

    @FindBy ( id = "Phone")
    public WebElement hotelEditPhone;

    @FindBy ( id = "Email")
    public WebElement hotelEditEmail;


    @FindBy ( id = "IDGroup")
    public WebElement hotelEditIDGroupDropAndDraw;

    @FindBy ( xpath = "//button[@class='btn green']")
    public WebElement hotelEditSaveButunu;

    @FindBy ( className = "bootbox-body")
    public WebElement DegisikliklerKaydEdildiMi;
